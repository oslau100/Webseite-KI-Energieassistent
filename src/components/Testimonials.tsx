...
export const Testimonials = () => {
  ...
  const reviews = [
    { title: t("review_1_title"), text: t("review_1_text"), name: t("review_1_name") },
    { title: t("review_2_title"), text: t("review_2_text"), name: t("review_2_name") },
    { title: t("review_3_title"), text: t("review_3_text"), name: t("review_3_name") },
    { title: t("review_4_title"), text: t("review_4_text"), name: t("review_4_name") },
  ];
    ...
    <section className="py-16 md:py-24 bg-muted/30">
      <div className="container px-4 md:px-6">
        <AnimatedSection className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          <p className="text-primary font-semibold tracking-wide uppercase text-sm">{t("testimonials_label")}</p>
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl">{t("testimonials_headline")}</h2>
        </AnimatedSection>
