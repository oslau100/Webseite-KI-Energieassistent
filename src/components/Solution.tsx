        ...
        <AnimatedSection className="bg-primary rounded-[2.5rem] shadow-2xl relative">
          <div className="grid lg:grid-cols-2 items-center">
            <div className="px-6 pt-10 pb-0 md:p-16 lg:p-20 space-y-8 text-primary-foreground z-10 relative">
              <h2 className="text-3xl font-bold tracking-tight sm:text-4xl md:text-5xl leading-tight">{t("banner_title")}</h2>
              <p className="text-lg md:text-xl text-primary-foreground/90 leading-relaxed max-w-lg">{t("banner_desc")}</p>
              <div className="pt-4">
                ...
                <p className="text-xs text-primary-foreground/70 mt-3">{t("hero_result_note")}</p>
              </div>
            </div>
            <div className="relative h-full min-h-[280px] md:min-h-[350px] lg:min-h-[500px] flex items-end justify-center lg:justify-end mt-8 md:mt-0">
              <img src="https://vibe.filesafe.space/1774643086282323006/attachments/16dfcd59-56c7-4ab2-bc63-3f59be3c5387.png" alt="Energieassistent" className="relative z-10 w-full max-w-[500px] md:max-w-[650px] lg:max-w-[850px] xl:max-w-[1000px] h-auto object-contain object-bottom drop-shadow-2xl translate-y-12 md:translate-y-8 lg:translate-y-12 lg:-mr-12 scale-[1.75] md:scale-125 lg:scale-150 origin-bottom" />
            </div>
          </div>
        </AnimatedSection>
      </div>
