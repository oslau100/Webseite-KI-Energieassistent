    ...
    <footer className="bg-muted pt-12 pb-2 md:py-16 border-t">
      <div className="container px-4 md:px-6">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div className="space-y-4"><h4 className="font-semibold text-foreground">{t("footer_legal")}</h4><div className="space-y-2 text-sm text-muted-foreground"><Link to={withLang("/datenschutz")} className="hover:text-primary transition-colors block">{t("footer_privacy")}</Link><Link to={withLang("/impressum")} className="hover:text-primary transition-colors block">{t("footer_imprint")}</Link><div className="-mt-12 -mb-12 md:-mt-2 md:mb-0"><a href="https://www.laurent-digital.de" target="_blank" rel="noopener noreferrer" className="inline-block hover:opacity-80 transition-opacity"><img src="https://vibe.filesafe.space/1774643086282323006/attachments/a629d547-6056-4079-8549-0a910a7eafbd.png" alt="Made by Laurent Digital" className="h-48 w-auto object-contain object-left -ml-6 sm:-ml-8 md:ml-0" /></a></div></div></div>
        </div>
      </div>
    </footer>
  );
